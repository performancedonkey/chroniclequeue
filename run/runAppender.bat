...
::set args=RTAlgorithms_200902_094745 "F DAX SEP20" 4631934
set args=RTAlgorithms_200910_020726 "F MINISP SEP20"
set main=chronicle.MainPlayer
set JAVA_VER=C:/Program Files/Java/jre1.8.0_261
echo %args% > output_appender.log
