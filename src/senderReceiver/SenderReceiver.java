...
public class SenderReceiver {
    ...
    public static void main(String[] args) {
        try {
            ...
            int sleep = Integer.valueOf(args[4]);
            ...
            packetLength = args.length > 5 ? Integer.valueOf(args[5]) : 12; // long + int
    ...
    private void doSenderCode(String ip, int port, String interfaceName, int sleep) {
        ...
        try {
            ...
            senderSocket.setInterface(InetAddress.getByName(interfaceName));
    ...
    HashSet<Integer> missedPacketSeqs = new HashSet<Integer>();
