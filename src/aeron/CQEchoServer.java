...
public final class CQEchoServer implements Closeable {
    private static final Logger log = LoggerFactory.getLogger(CQEchoServer.class);
    ...
    public static CQEchoServer create(
        ...
        try {
            ...
            return new CQEchoServer(media_driver, aeron, local_address);
        } catch (final Exception e) {
...
//        System.out.println("asa");
        ...
        log.info("run");
        try (final CQEchoServer server = create(directory, local_address)) {
            server.run();
        }
        log.info("running");
    }
